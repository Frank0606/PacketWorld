...
class perfilConductorActivity : AppCompatActivity() {
    ...
    private fun cargarDatosConductor() {
        ...
        if (conductorJson != null) {
            ...
            binding.tvNombreValor.text = "${colaborador.nombre} ${colaborador.apellidoPaterno} ${colaborador.apellidoMaterno}"
    ...
    private fun actualizarFotoServicio() {
        ...
        Ion.with(this)
            ...
            .setCallback { e, result ->
                if (e != null) {
                    Toast.makeText(this, "Error al actualizar foto: ${e.message}", Toast.LENGTH_LONG).show()
                    return@setCallback
                }
